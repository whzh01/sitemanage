   ...
   <div class="graphs">	
    <div class="content_bottom">
	  <div class="bs-example1" data-example-id="contextual-table">
		...
		<form class="form-horizontal"  name="updateUser" id="updateUser" action="<?php echo U('Home/Users/update_user',array('id'=>I('get.id')));?>" method="post" >
			 
			<div class="form-group">
				<label class="control-label">用户名：</label>
				<input type="text" class=" form-control1" name="user"  value="<?php echo ($user["username"]); ?>" disabled/>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label">学院：</label><input type="text" class="form-control1" name="xueyuan" value="<?php echo ($user["college"]); ?>"/>
			</div>
			<div class="form-group"><label>负责人：</label><input type="text" class="form-control1" name="name" value="<?php echo ($user["name"]); ?>"/></div>
			<div class="form-group"><label>联系方式：</label><input type="text" class="form-control1" name="tel" value="<?php echo ($user["tel"]); ?>"/></div>
			<div class="form-group"><label>密码：</label><input type="text" class="form-control1" name="pwd" value="<?php echo ($user["password"]); ?>"/></div>
			
			<div ><button class="btn btn-default" onclick="add();">修改</button>
...
{
	$("#auth<?php echo ($user["auth"]); ?>").attr('checked','checked');
	$("#group<?php echo ($groups); ?>").attr('checked','checked');
