							...
							<form class="form-horizontal" action="<?php echo U('Home/Apply/index');?>" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<div class="checkbox-inline1"><label><input type="checkbox" name="ActSite[]" value='研教楼一、二楼栏杆处' <?php if(in_array('研教楼一、二楼栏杆处',$form['ActSite'])): ?>checked<?php endif; ?> > 研教楼一、二楼栏杆处</label></div>
										<div class="checkbox-inline1"><label><input type="checkbox" name="ActSite[]" value='研教楼报告厅' <?php if(in_array('研教楼报告厅',$form['ActSite'])): ?>checked<?php endif; ?> > 研教楼报告厅</label></div>
										<div class="checkbox-inline1"><label><input type="checkbox" name="ActSite[]" value='北山公寓' <?php if(in_array('北山公寓',$form['ActSite'])): ?>checked<?php endif; ?> > 北山公寓</label></div>
										<div class="checkbox-inline1"><label><input type="checkbox" name="ActSite[]" value='西山研究生公寓' <?php if(in_array('西山研究生公寓',$form['ActSite'])): ?>checked<?php endif; ?> > 西山研究生公寓</label></div>
										<div class="checkbox-inline1"><label><input type="checkbox" name="ActSite[]" value='大黑楼前栏杆' <?php if(in_array('大黑楼前栏杆',$form['ActSite'])): ?>checked<?php endif; ?> > 大黑楼前栏杆</label></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><select  id="selector1" class="form-control1" name="ActStyle">
										<option <?php if($form['LiteratureStyle'] == '条幅'): ?>selected<?php endif; ?>>条幅</option>
										<option <?php if($form['LiteratureStyle'] == '海报'): ?>selected<?php endif; ?> >海报</option>
										<option <?php if($form['LiteratureStyle'] == '条幅、海报'): ?>selected<?php endif; ?>>条幅、海报</option>
										<option <?php if($form['LiteratureStyle'] == '其他'): ?>selected<?php endif; ?>>其他</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><textarea name="ActCon" id="ActCon" cols="50" rows="5" class="form-control1" ><?php echo ($form['ActCon']); ?></textarea></div>
								</div>
								<div class="form-group">
