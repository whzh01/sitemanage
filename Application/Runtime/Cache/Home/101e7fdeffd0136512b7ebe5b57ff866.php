...
<body>
   ...
   <div class="navbar-default sidebar" role="navigation">
        ...
        <div class="graphs">
	     <div class="xs">
  	       <h3 style="text-align:center">研教楼广场借用申请表</h3>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<?php echo U('Home/Apply/index');?>" method="post">
								...
								<div class="form-group">
									<label for="selector1" class="col-sm-2 control-label">活动用途</label>
									<div class="col-sm-8"><select  id="selector1" class="form-control1" name="ActStyle">
										<option <?php if($form['LiteratureStyle'] == '学术讲座'): ?>selected<?php endif; ?>>学术讲座</option>
										<option <?php if($form['LiteratureStyle'] == '会议'): ?>selected<?php endif; ?>>会议</option>
										<option <?php if($form['LiteratureStyle'] == '学生活动'): ?>selected<?php endif; ?>>学生活动</option>
